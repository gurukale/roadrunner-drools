...
<body>
	...
	<div id="page-heading">
		<h1>
			<spring:message code="person.create.page.title" />
		</h1>
		<a href="/" class="hyperline"><spring:message
				code="person.list.link.label" /></a>
	</div>
	<!-- end page-heading -->

	<div class=createpg>
		<form:form action="/person/createOrder" commandName="order"
			method="POST">
			<table border="0">
				<tr>

					<td><form:label path="firstName">
							<spring:message code="person.label.firstName" />:</form:label></td>
				...
				<tr>
					<td><form:label path="lastName">
							<spring:message code="person.label.lastName" />:</form:label></td>
				...
				<tr>
					<td><form:label path="lastScreen">
							<spring:message code="person.label.lastScreen" />:</form:label></td>
				...
				<tr>
					<td><form:label path="propositionCheck">
							<spring:message code="person.label.propositionCheck" />:</form:label></td>
				...
				<tr>
					<td><form:label path="extraCheck">
							<spring:message code="person.label.extraCheck" />:</form:label></td>
				...
				<tr>
					<td><form:label path="giftCheck">
							<spring:message code="person.label.giftCheck" />:</form:label></td>
				...
				<tr>
					<td><form:label path="insurance">
							<spring:message code="person.label.insurance" />:</form:label></td>
				...
				<tr>
					<td><form:label path="proofsValid">
							<spring:message code="person.label.proofsValid" />:</form:label></td>
				...
				<tr>
					<td><form:label path="creditCheckValid">
							<spring:message code="person.label.creditCheckValid" />:</form:label></td>
				...
				<tr>
					<td><form:label path="fraudCheckValid">
							<spring:message code="person.label.fraudCheckValid" />:</form:label></td>
				...
				<tr>
					<td><form:label path="valdityCheck">
							<spring:message code="person.label.valdityCheck" />:</form:label></td>
				...
				<tr>
					<td><form:label path="valdityCheckValue">
							<spring:message code="person.label.valdityCheckValue" />:</form:label></td>
				...
				<tr>
					...
					<td><input type="submit"
						value="<spring:message code="person.create.page.submit.label"/>" /></td>
				</tr>
			</table>
		</form:form>
	</div>
